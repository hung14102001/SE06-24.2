...
function App() {
  ...
  async function fetchOwnerTokenAmount() {
    if (window.ethereum) {
      ...
      try {
        ...
        setOwnerTokenAmount(Math.round(parseInt(data["_hex"], 16) / 1e18));
      } catch (err) {
        console.log(err);
      }
    }
  ...
  function convertAccount() {
    if (userAccount != "0")
      return userAccount.substring(0, 4) + "..." + userAccount.slice(-4);
  ...
  async function exchangeCoin() {
    if (coinExchangeAmount > 0 && coinExchangeAmount % 10 == 0) {
      ...
      await tokenContract.mint(coinExchangeAmount, {
        value: coinExchangeAmount * ethToAT,
      });
    } else {
      ...
      <div>
            ...
            <div id="nav-wrapper">
              <div id="navbar">
                ...
                <div className="nav-right-content">
                    ...
                    <Popup trigger={popup} setTrigger={setPopup}>
                      <div style={{ marginBottom: "24px" }}>
                        ...
                        <input
                          placeholder="Amount"
                          onChange={(e) => {
                            setCoinExchangeAmount(e.target.value);
                            setExchangeNote("");
                          }}
                        />
                    ...
                    >
                      ...
                      <div className="nav-mobile-play-now">
                        <div className="nav-mobile-menu-link-list">
                          ...
                          <Link to="/stake">
                            <a className="nav-mobile-menu-link">STAKE</a>
                          </Link>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="nav-account-anonymous-link-wrapper">
                      <a id="nav-account" onClick={requestAccount}>
                        {convertAccount()}
                      </a>
                    </div>
                  </div>
        ...
        <Routes>
          ...
          <Route
            exact
            path="/storage"
            element={<Storage userAccount={userAccount} />}
          />
          <Route
            exact
            path="/stake"
